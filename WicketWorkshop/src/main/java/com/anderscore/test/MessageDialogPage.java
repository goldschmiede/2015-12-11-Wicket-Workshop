...
public class MessageDialogPage extends WebPage
{
	...
	public MessageDialogPage()
	{
		...
		final MessageDialog errorDialog = new MessageDialog("errorDialog", "Error", "That was an error...", DialogButtons.OK, DialogIcon.ERROR) {
